"""
BlueZ pairing agent — auto-accepts all pairing methods.

iOS requires a pairing agent to handle passkey/PIN exchanges. This agent
auto-confirms passkeys and auto-authorizes service connections so the
...
class PairingAgent(dbus.service.Object):
    """Auto-accept pairing agent using KeyboardDisplay capability."""
